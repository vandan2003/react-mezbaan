...
export default function Home() {
    ...
    return <>
        ...
        <hr />
        <div className="row" id="multi-cuisines">
            <h2>Multi Cuisines</h2><div className="col-8"></div>
            <div className="col-3 cuisine-card-holder">
        ...
        <div className="row" id="top-rated">
            <h2>Top Rated</h2><div className="col-8"></div>

            {
                topRatedFour?.map((restaurant, index) => {
                    return <>
                        <div  key={index} className="col-3 cuisine-card-holder">
                            <div  className="card-hover">
                                <div className="card-hover__content">
